...
::String File_obj::getContent( ::String path){
	HX_STACK_PUSH("File::getContent","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/File.hx",27);
...
::haxe::io::Bytes File_obj::getBytes( ::String path){
	HX_STACK_PUSH("File::getBytes","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/File.hx",32);
	HX_STACK_ARG(path,"path");
	HX_STACK_LINE(33)
...
{
		HX_STACK_PUSH("File::saveContent","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/File.hx",37);
		HX_STACK_ARG(path,"path");
...
bool binary = __o_binary.Default(true);
	HX_STACK_PUSH("File::write","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/File.hx",53);
	HX_STACK_ARG(path,"path");
